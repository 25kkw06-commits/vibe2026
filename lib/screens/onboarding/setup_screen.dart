...
import '../limits/app_picker_screen.dart';
import '../limits/limit_edit_screen.dart';
        ...
        child: Column(
          ...
          children: [
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 8),
                    Text(
                      '스토어 밖에서 설치한 앱은 「제한된 설정」이 막혀 있을 수 있습니다.\n\n'
                      '설정 → 앱 → 타임고치 → 오른쪽 위 ⋮(더보기) → '
                      '「제한된 설정 허용」을 켠 뒤, 다시 이 화면에서 '
                      '「설정 열기」로 사용 정보 접근을 허용해 주세요.',
                      style:
                          TextStyle(fontSize: 12.5, color: muted, height: 1.45),
                    ),
                  ],
                ),
              ),
            ...
            TextButton.icon(
              ...
              icon: const Icon(Icons.app_settings_alt_outlined, size: 20),
              label: const Text('이 앱 설정(제한된 설정) 화면으로'),
            ),
            const SizedBox(height: 8),
            FilledButton(
              onPressed: () async {
      ...
      content: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 16),
            Text(
              '• 홈 · 기록 · 상점: 돌봄은 홈, 점수는 기록, 상점에서 사료·비누·장난감을 크레딧으로 살 수 있어요.\n'
              '• 30일 기록 주기를 한 번 채우면 점수 합에 따라 크레딧이 들어와요.\n'
              '• 배고픔·청결이 매우 나쁜 상태가 3일 연속(날짜 마감 기준)이면 타임고치가 죽을 수 있어요. 그때는 메시지를 보고 새로 시작할 수 있습니다.',
              style: TextStyle(
                fontSize: 13,
                height: 1.5,
